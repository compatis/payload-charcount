...
import { CharcountTextField } from '../CharcountTextField.js'

describe('CharcountTextField', () => {
  describe('basic functionality', () => {
    it('should create a text field with default configuration', () => {
      ...
      const result = CharcountTextField(overrides, config)
    ...
    it('should create a field with type "text"', () => {
      const config = { max: 100, min: 0 }
      const overrides = { name: 'testField' }
  ...
  describe('config parameter handling', () => {
    it('should pass config as clientProps to CharCount component', () => {
      ...
      const result = CharcountTextField(overrides, config)
      const field = result as TextField
    ...
    it('should handle different config values', () => {
      ...
      const result1 = CharcountTextField(overrides, config1)
      const result2 = CharcountTextField(overrides, config2)

      const field1 = result1 as TextField
      const field2 = result2 as TextField
  ...
  describe('type safety and edge cases', () => {
    it('should handle undefined overrides gracefully', () => {
      ...
      const result = CharcountTextField(undefined, config)
    ...
    it('should handle null overrides gracefully', () => {
      ...
      const result = CharcountTextField(null, config)
  ...
  describe('return value structure', () => {
    ...
    it('should return a field that can be used in Payload collections', () => {
      ...
      expect(field).toHaveProperty('type')
      expect(field as { name: string } & TextField).toHaveProperty('name')
      expect(typeof field.type).toBe('string')
      expect(typeof (field as { name: string } & TextField).name).toBe('string')
    })
  })
})
